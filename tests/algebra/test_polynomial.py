...
class TestAdd:
    def test_add(self):
        f = Polynomial(
            coeffs=[bn128_FR(1), bn128_FR(1), bn128_FR(3), bn128_FR(0), bn128_FR(40)]
        )
        g = Polynomial(coeffs=[bn128_FR(0), bn128_FR(0), bn128_FR(1), bn128_FR(3)])

        expected = Polynomial(
            coeffs=[bn128_FR(1), bn128_FR(1), bn128_FR(4), bn128_FR(3), bn128_FR(40)]
        )
        assert f + g == expected
...
class TestSub:
    def test_sub(self):
        ...
        expected = Polynomial(
            coeffs=[bn128_FR(1), bn128_FR(1), bn128_FR(2), bn128_FR(-3), bn128_FR(40)]
        )
        assert f - g == expected
    ...
    def test_sub_longer_poly(self):
        ...
        g = Polynomial(
            coeffs=[bn128_FR(4), bn128_FR(0), bn128_FR(1), bn128_FR(3), bn128_FR(10)]
        )

        expected = Polynomial(
            coeffs=[bn128_FR(-4), bn128_FR(0), bn128_FR(0), bn128_FR(0), bn128_FR(-10)]
        )
        assert f - g == expected
    ...
    def test_sub_scalar(self):
        ...
        expected = Polynomial(
            coeffs=[bn128_FR(-4), bn128_FR(1), bn128_FR(3), bn128_FR(0), bn128_FR(40)]
        )
        assert f - g == expected
...
class TestMul:
    def test_mul(self):
        ...
        expected = Polynomial(
            coeffs=[bn128_FR(12), bn128_FR(50), bn128_FR(52), bn128_FR(5)]
        )
        assert f * g == expected
...
class TestDiv:
    ...
    def test_div_scalar(self):
        ...
        expected_quo = Polynomial(
            coeffs=[bn128_FR(5), bn128_FR(2), bn128_FR(0), bn128_FR(1)]
        )
        expected_rem = Polynomial(coeffs=[bn128_FR(0)])
...
class TestLagrange:
    def test_lagrange_poly(self):
        ...
        (expected, _) = Polynomial(
            coeffs=[bn128_FR(-8), bn128_FR(14), bn128_FR(-7), bn128_FR(1)]
        ) / bn128_FR(-2)
        assert (
            Polynomial.lagrange_poly(domain=domain, index=2, field_class=bn128_FR)
            == expected
        )
    ...
    def test_interpolate_poly(self):
        ...
        assert (
            Polynomial.interpolate_poly(
                domain=domain, values=values, field_class=bn128_FR
            )
            == expected
        )
